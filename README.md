...
We have created a default session manager in package `github.com/kisrobot/session/manager`, which is used in some QOR libs like QOR Admin, QOR Auth by default to manage session, flash messages.
